...
SDXLC_VERSION='1.0.0'
SDXLC_MONGODB_CONNSTRING='mongodb://sdx:passw@192.168.0.13:27017/'
SDXLC_DB_NAME='test-db'
SDXLC_DB_CONFIG_TABLE_NAME='sdx-config-test-1'
DOMAIN_CONTROLLER_URL='http://192.168.0.14:8080/SDX-LC/1.0.0/provision'
DOMAIN_CONTROLLER_PULL_URL='http://192.168.0.124:8080/SDX-LC/1.0.0/topology'
